...
function check_remote()
{
	...
	if(support_force_https == "1") {
                if((cf.https_enable_check.checked == true && enable_force_https != "1") || (cf.https_enable_check.checked == false && enable_force_https == "1")) {
                        cf.https_enable_change.value = 1;
                } else {
                        cf.https_enable_change.value = 0;
                }
                if(cf.https_enable_check.checked == true) {
                        cf.https_enable.value = 1;
                } else {
                        cf.https_enable.value = 0;
                }
        }
